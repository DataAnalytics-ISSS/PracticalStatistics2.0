...
Although the quizzes in this lesson are not necessary to successfully complete the project (though they are helpful), all of the items on the Project Rubric(opens in a new tab) must meet specifications to successfully complete the project.
